...
import com.kt.android.MainActivity
...
class NotificationWorker(context: Context, workerParameters: WorkerParameters) :
    ...
    override fun doWork(): Result {
        val title: String = inputData.getString(WorkManagerActivity.KEY_WORK_TITLE).toString()
        val content: String = inputData.getString(WorkManagerActivity.KEY_WORK_CONTENT).toString()
